...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex flex-col gap-10 items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            ...
            <div class="mt-10 px-5 py-1.5 border text-gray-500 border-gray-500 hover:bg-gray-500 hover:text-white cursor-pointer rounded transition delay-150 ease-in-out">
                @if (Route::has('login'))
                    @auth
